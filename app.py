...
if selected_key == "cs_shift_calendar":
    ...
    if _cs_y == 2026 and _cs_m == 6:
        ...
        _PROPOSED_MOVES = [
            ("室谷", 8, 5),     # 6/5 3条件 (原田のみ→原田+室谷)
            ("佐々木", 12, 11), # 6/11 2条件 (なし→佐々木)
            ("原田", 23, 19),   # 原田6/23NG解消 + 6/19 3条件
            ("栗田", 2, 1),     # 6/1 補強 / 栗田 [2-4]3連→[3-4]2連 (勘七から栗田に変更)
            ("吉本", 4, 1),     # 6/1 補強 / 吉本 [2-4]3連→[2-3]2連
            ("堀田", 4, 1),     # 6/1 補強 / 堀田 [2-4]3連→[2-3]2連
        ]
